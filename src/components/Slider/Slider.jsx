...
const Slider = () => {
	...
	return (
		<div className='slider-container'>
			{slideIndex !== 0 && <Arrow handleClick={() => handleClick('left')} className='bi bi-chevron-double-left arrow-left' />}
			...
			{slideIndex !== 2 && <Arrow handleClick={() => handleClick('right')} className='bi bi-chevron-double-right arrow-right' />}
		</div>
	)
}
